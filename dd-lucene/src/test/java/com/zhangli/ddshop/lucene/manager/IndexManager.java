package com.zhangli.ddshop.lucene.manager;

import com.zhangli.ddshop.lucene.dao.impl.BookDaoImpl;
import com.zhangli.ddshop.lucene.dao.impl.IBookDao;
import com.zhangli.ddshop.lucene.po.Book;
...
public class IndexManager {
    ...
    public void indexSearch() throws Exception {
        ...
        Query query=parser.parse("name:solr");
        //指定索引库的地址
        File indexFile=new File("D:\\bookindex");
        Directory directory=FSDirectory.open(indexFile);
